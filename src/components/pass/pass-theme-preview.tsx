    ...
    <div className="mt-6 grid gap-6">
      ...
      <section>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div><p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">Theme Overview</p><h2 className="mt-2 text-2xl font-semibold">Theme comparison</h2></div>
      ...
      <section>
        ...
        <h2 className="mt-2 text-2xl font-semibold">Light and Dark Modes</h2>
